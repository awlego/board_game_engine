...
# The random-policy bot helpers grew up in this file's full-game fuzz
# and now ship as the server-driven Random Bot (re-exported here for
# test_agricola_draft.py).
from server.agricola.bot import (
    SAFE_SPACES, random_bot_action, bot_fallback,
)
